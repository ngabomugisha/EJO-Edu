        ...
        csvtojson()
            ...
            .then(async (rows) => {
                rows.map(row => {
                    ...
                    if (row.field4 !== "") {
                        subject.topics[topic].subtopics[subtopic].units[unit].numberOfPeriods = row.field4
                    }
                    if (row.field5 !== "") {
                        subject.topics[topic].subtopics[subtopic].units[unit].keyCompetency = row.field5
                    }
                    if (row.field6 !== "") {
                ...
                const createdSubject = await Subject.create(subject.name);
