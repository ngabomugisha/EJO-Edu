...
exports.create = async (req, res) => {
    try {
        const {
            title, assignedClass, course
        } = req.body;
        const teacher = req.user._id

        Assignment.create(title, assignedClass, course, teacher)
        .then(results => {
...
exports.getAllClassCourseAssignmentes = async (req, res) => {
    try {

        const classId = req.params.classId;
        const courseId = req.params.courseId
        Assignment.getAllClassCourseAssignmentes(classId, courseId)
            .then(results => {
