...
export default () => {
  ...
  const [rows, setRows] = useState([{'id' :1, 'product' : "robert", "region":"region"},{'id' :3, 'product' : "robert", "region":"region"},{'id' :2, 'product' : "robert", "region":"region"}]);
  ...
  const [columnOrder, setColumnOrder] = useState(['product', 'region']);
